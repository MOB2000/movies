...
import 'package:movies/utils/star_calculator.dart' as starCalculator;
import 'package:movies/utils/toast_alert.dart' as alert;
...
class DetailsScreen extends StatefulWidget {
  ...
  const DetailsScreen({super.key, required this.id, required this.themeColor});
